            ...
            <div className='flex flex-col p-4 justify center max-w-screen-lg mx-auto h-full'>
                ...
                <div className='flex justify-center items-center'>
                    <form action='https://getform.io/f/c3f78cde-5a36-478e-a6e5-f75c4a35b2a2' method='POST' className='flex flex-col w-full md:w-1/2' >
                        ...
                        <button className='text-white bg-gradient-to-r from-blue-500  to-purple-500 px-6 py-3 my-9 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's Talk</button> 
